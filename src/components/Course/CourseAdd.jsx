          ...
          <form className='form' onSubmit={handleSubmit}>
            ...
            <div className='contact my-1'>
              <p className='lead'>
                ...
                <small className='form-text'>
                  Select images that will attract users to enroll in the course
                </small>
              </p>
              <div className='form-group'>
                <input
            ...
            <div className='contact my-1'>
              ...
              <div className='form-group'>
                <input
                  ...
                  className={
                    touched.nextCourse && errors.nextCourse ? 'has-error' : null
                  }
                />
                <Error
            ...
            <div className='contact my-1'>
              ...
              <div className='form-group'>
                ...
                />
                <Error touched={touched.schoolImg} message={errors.schoolImg} />
              </div>
            </div>
            <button
              style={{ width: '100%' }}
...
export default connect(null, mapDispatchToProps)(CourseAdd);
